...
def upload_files_to_streetplay_gcp_bucket(file_pairs):
    """
    ...
    """
    bucket_name = 'street-data'
    storage_client = storage.Client.from_service_account_json("../../keys/streetplay_dev_gcs_access_key.json")
...
if __name__ == "__main__":
    ...
    game_code_list = ['Game1_0804', # Bangalore Play 365 FPS 60
                      ...
                      'Game192_0224'    # Boyfun FC vs AC Atlanta
                      #'GameX'
                      ]    
    
    #game_code = game_code_list[25]
    game_codes = game_code_list[40:50]
    ...
    n_files_from_game_code['Game1_0804'] = 3
    n_files_from_game_code['Game2_0805'] = 2
    n_files_from_game_code['Game3_0807'] = 2
    
    n_files_from_game_code['Game5_0825'] = 1
    n_files_from_game_code['Game8_0803'] = 1
    n_files_from_game_code['Game9_0911'] = 1
    n_files_from_game_code['Game11_0913'] = 1

    n_files_from_game_code['Game13_0919'] = 1
    n_files_from_game_code['Game14_0919'] = 1
    n_files_from_game_code['Game15_0918'] = 1

    n_files_from_game_code['Game16_0916'] = 1
    n_files_from_game_code['Game18_0920'] = 1
    n_files_from_game_code['Game19_0925'] = 4

    n_files_from_game_code['Game20_1001'] = 1
    n_files_from_game_code['Game21_0921'] = 1
    n_files_from_game_code['Game22_1003'] = 1
    n_files_from_game_code['Game23_1004'] = 1
    ...
    for game_code in game_codes:
        ...
        local_folder_path = '../videos/game-recordings/'+game_code+'/'
    ...
    upload_files_to_streetplay_gcp_bucket(file_pairs)