...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"")
        print(f"🎬 SAMPLE CLIP URL:")
        print(f"https://end-nov-webapp-clann.s3.amazonaws.com/sample-clips/{match_id}/sample_clip.mp4")
        print(f"")
        print(f"👁️  NEXT STEP: Watch sample clip to identify teams")
        print(f"🎯 Then run: python3 1.3_setup_match.py {match_id}")
    else:
        sys.exit(1) 