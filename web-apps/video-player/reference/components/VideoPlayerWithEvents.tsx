        ...
        <div className="max-w-7xl w-full">
          <Card className="shadow-lg border-0 bg-transparent">
            <CardContent className="p-2 space-y-0">
              <div data-video-container className={`relative ${!isFullscreen ? 'flex justify-between' : ''}`}>
                <div className={!isFullscreen ? 'min-w-0 w-[calc(100%-320px)]' : 'w-full'}>
                ...
                {showEventsManager && sidebarVisible && (
                ...
                {showEventsManager && (
                  <Button
                    ...
                    className="fixed top-4 right-4 z-[9999] bg-red-500 text-white hover:bg-red-600 px-3 py-1 rounded-md shadow-lg"
                    title={sidebarVisible ? "Hide Events Panel" : "Show Events Panel"}
                  >
                    {sidebarVisible ? "Hide Events" : "Show Events"}
                  </Button>
                )}
              </div>
            </CardContent>
