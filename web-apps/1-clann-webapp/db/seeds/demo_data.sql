...
-- Insert demo users (team owners + test users)
INSERT INTO users (id, email, password_hash, name) VALUES
  ('11111111-1111-1111-1111-111111111111', 'arsenal@demo.com', '$2b$10$demo_hash_1', 'Arsenal Coach'),
  ('22222222-2222-2222-2222-222222222222', 'chelsea@demo.com', '$2b$10$demo_hash_2', 'Chelsea Coach'),
  ('33333333-3333-3333-3333-333333333333', 'liverpool@demo.com', '$2b$10$demo_hash_3', 'Liverpool Coach'),
  ('44444444-4444-4444-4444-444444444444', 'city@demo.com', '$2b$10$demo_hash_4', 'City Coach'),
  ('55555555-5555-5555-5555-555555555555', 'united@demo.com', '$2b$10$demo_hash_5', 'United Coach'),
  ('99999999-9999-9999-9999-999999999999', 'demo@clann.ai', '$2b$10$sW7qjE7P4.6BjXI0vJ9X2eCr8jE9VjK4bR2L8wX3sA1mN6pQ5tY7z', 'Demo User'),
  ('88888888-8888-8888-8888-888888888888', 'admin@clann.ai', '$2b$10$sW7qjE7P4.6BjXI0vJ9X2eCr8jE9VjK4bR2L8wX3sA1mN6pQ5tY7z', 'Admin User'),
  ('77777777-7777-7777-7777-777777777777', 'analyst@clann.ai', '$2b$10$sW7qjE7P4.6BjXI0vJ9X2eCr8jE9VjK4bR2L8wX3sA1mN6pQ5tY7z', 'Company Analyst');
